...
describe("RunArtifactWriter", () => {
  ...
  it("writes a dated digest file and appends an index.jsonl entry", async () => {
    ...
    const digestPath = join(rootDir, "2026-04-12", "digest-3986ebbc.md");
    ...
    expect(entry.digestPath).toBe("2026-04-12/digest-3986ebbc.md");
  });
  ...
  it("appends to index.jsonl across multiple wakes on the same day", async () => {
    ...
    expect(a.digestPath).toBe("2026-04-12/digest-11111111.md");
    expect(b.digestPath).toBe("2026-04-12/digest-22222222.md");
  });
